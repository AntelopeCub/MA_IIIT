...
if __name__ == "__main__":
    ...
    surf_path = "D:/Rain/text/Python/MA_IIIT/models/vgg16/surface/vgg16_bn_128_norm_SGDNesterov_l2_avg_cifar_auto_234_0.9183_weights_2D_surface_51.h5"

    plot_2d_contour(surf_path, surf_name='train_loss', vmin=0.1, vmax=5, vlevel=0.2, show=True)
